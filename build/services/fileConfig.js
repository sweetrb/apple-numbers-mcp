 ...
 * way to pass `APPLE_NUMBERS_MCP_*` settings in. This loads them from a JSON file
 ...
 *
 * Path: `APPLE_NUMBERS_MCP_CONFIG_FILE`, else
...
export function fileConfigPath(env = process.env) {
    ...
    return join(homedir(), "Library", "Application Support", "apple-numbers-mcp", "config.json");
}
/**
