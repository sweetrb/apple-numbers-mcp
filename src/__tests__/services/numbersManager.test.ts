...
describe('NumbersManager', () => {
  ...
  describe('validatePath', () => {
    it('should throw for non-existent files', () => {
      ...
      expect(() => manager.getFileInfo('/missing.numbers')).toThrow(
        'File not found',
      );
    });

    it('should throw for non-.numbers files', () => {
      expect(() => manager.getFileInfo('/data.xlsx')).toThrow(
        'Not a Numbers file',
      );
    });
  ...
  describe('getFileInfo', () => {
    ...
    it('should throw when Python bridge returns error', () => {
      ...
      expect(() => manager.getFileInfo('/test.numbers')).toThrow(
  ...
  describe('exportTable', () => {
    it('should pass format and output path', () => {
      ...
      const result = manager.exportTable(
        '/test.numbers',
        'csv',
        '/tmp/output.csv',
      );
